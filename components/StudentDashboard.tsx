...
export const StudentDashboard: React.FC<Props> = ({ user, dailyStudySeconds, onSubjectSelect, onRedeemSuccess, settings, onStartWeeklyTest }) => {
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-2 gap-2 bg-white p-2 rounded-xl border border-slate-200 shadow-sm mb-8 sticky top-20 z-20">
            <button onClick={() => {setActiveTab('VIDEO'); setContentViewStep('SUBJECTS');}} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'VIDEO' ? 'bg-red-50 text-red-600' : 'text-slate-400 hover:bg-slate-50'}`}><Youtube size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Video</span></button>
            <button onClick={() => {setActiveTab('PDF'); setContentViewStep('SUBJECTS');}} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'PDF' ? 'bg-blue-50 text-blue-600' : 'text-slate-400 hover:bg-slate-50'}`}><FileText size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Notes</span></button>
            <button onClick={() => {setActiveTab('MCQ'); setContentViewStep('SUBJECTS');}} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'MCQ' ? 'bg-purple-50 text-purple-600' : 'text-slate-400 hover:bg-slate-50'}`}><CheckSquare size={24} className="mb-1" /><span className="text-sm font-bold uppercase">MCQ</span></button>
            
            <button onClick={() => setActiveTab('CHAT')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'CHAT' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><MessageCircle size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Chat</span></button>
            <button onClick={() => setActiveTab('LEADERBOARD')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'LEADERBOARD' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><Trophy size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Rank</span></button>
            {isGameEnabled && <button onClick={() => setActiveTab('GAME')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'GAME' ? 'bg-orange-50 text-orange-600' : 'text-slate-400 hover:bg-slate-50'}`}><Gamepad2 size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Game</span></button>}
            <button onClick={() => setActiveTab('HISTORY')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'HISTORY' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><History size={24} className="mb-1" /><span className="text-sm font-bold uppercase">History</span></button>
            <button onClick={() => setActiveTab('REDEEM')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'REDEEM' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><Gift size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Redeem</span></button>
            <button onClick={() => setActiveTab('STORE')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'STORE' ? 'bg-gradient-to-br from-green-400 to-blue-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><ShoppingBag size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Store</span></button>
            <button onClick={() => setActiveTab('PROFILE')} className={`flex flex-col items-center justify-center p-4 rounded-lg transition-all ${activeTab === 'PROFILE' ? 'bg-gradient-to-br from-purple-400 to-indigo-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><Settings size={24} className="mb-1" /><span className="text-sm font-bold uppercase">Profile</span></button>
        </div>
